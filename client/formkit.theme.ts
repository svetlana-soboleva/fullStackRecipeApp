...
/**
  ...
  *
  * @checksum - b542bf3557ce6336c2662aaa1fabcfc10c33ddec0161eb2fc83a60d9714fad2c
  * @variables - radius=rounded,accentColor=green,colorTemperature=slate,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=600,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
