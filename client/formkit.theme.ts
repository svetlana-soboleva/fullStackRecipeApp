...
/**
  ...
  *
  * @checksum - 95f8709e14df04bc0bacee95df6aa2838c64c88fdfa6bc8f7ae3746d4ca51207
  * @variables - radius=rounded,accentColor=teal,colorTemperature=zinc,spacing=1.5,scale=base,inputShadow=shadow-sm,baseColorShade=600,borderShadeLightMode=300,borderShadeDarkMode=400,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
